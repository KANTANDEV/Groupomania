...
const CardComments = ({ post }) => {
    ...
    const handelComment = (e, uid) => {
        e.preventDefault();
        if (text) {
            dispatch(addComment(post._id, userData._id, text, usersData.pseudo, uid))
        ...
        <div className='comments-container'>
            ...
            {userData._id && (
                <form onSubmit={handelComment} className='comment-form'>
                    <input type='text' value={text} onChange={(e) => setText(e.target.value)} placeholder="Laisser un commentaire" /> 
                    <br />
